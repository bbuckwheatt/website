/*
 * gallery/ireland/page.tsx — ireland photo album
 *
 * SERVER COMPONENT — pre-rendered at build time.
 *
 * Photos for this album have not been added yet.
 * To add photos:
 *   1. Place .jpeg/.jpg files in public/images/gallery/ireland/
...
export const metadata: Metadata = {
  title: 'ireland',
  description: 'Photos from ireland.',
};
...
export default function irelandPage() {
  return (
    <div className="px-10 pt-12 pb-24 max-w-[1100px] mx-auto max-sm:px-6 max-sm:pt-8 max-sm:pb-16">
      ...
      <h1 className="text-[2.2rem] mb-4">ireland</h1>
