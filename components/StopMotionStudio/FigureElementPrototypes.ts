/*
 * FigureElementPrototypes.ts — Prototype figure configurations
 *
 * Pure data file — no browser APIs, safe to import anywhere.
 * Renamed from .tsx to .ts since there is no JSX in this file.
 */
