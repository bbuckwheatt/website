...
/*
 * FigureElements.tsx — Figure (person/animal/bird) data types and Konva renderers
 *
 * WHY 'use client':
 *   Uses react-konva (Rect, Circle, RegularPolygon) which renders to the Canvas API.
 *   Canvas is browser-only — this file must never run on the server.
 */
